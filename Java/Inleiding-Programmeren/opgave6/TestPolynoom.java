...
public class TestPolynoom {
	...
	public static void testPolynomen() {
		...
		// Polynoom polynoom5 = new Polynoom("test1.txt", true);
		// Polynoom polynoom6 = new Polynoom(2, 2, 2);
		// Polynoom polynoom7 = new Polynoom(3, 3, 3);
		Polynoom polynoom8 = new Polynoom("testtest.txt", true);

		System.out.println(polynoom8);
		polynoom8.test();
	...
	// 	testSave(polynoom1, polynoom2, polynoom3, polynoom4, polynoom5, polynoom6, polynoom7);
	...
	public static void testIfConstant(Paar test1, Paar test2, Paar test3, Paar test4, Paar test5) {
		System.out.println("Paar 5 is constant: " + test5.getConstant());
	...
	public static void testSave(Polynoom polynoom1, Polynoom polynoom2,
		...
		polynoom3.savePolynoom("test1.txt");
		polynoom1.savePolynoom("test2.txt");
		System.out.println();
	}
