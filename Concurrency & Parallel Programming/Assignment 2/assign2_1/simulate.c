        ...
        double *current_array, double *next_array)
{
    ...
    We accounted for a negative dividend. */
    ...
    // TODO: Optimalise by receiving slices in any order / from MPI_ANY_SOURCE.
    // However, the incremental version of computing the range of every slice relies on order.
